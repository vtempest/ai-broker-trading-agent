 ...
 * Converted from Python OpenBB congress_gov constants
 */

export const BASE_URL = 'https://api.congress.gov/v3/';

export const BillTypes = ['hr', 's', 'hjres', 'sjres', 'hconres', 'sconres', 'hres', 'sres'] as const;
...
export const billTypeDocstring = `Bill type (e.g., "hr" for House bills).
