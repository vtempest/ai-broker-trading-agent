...
export declare type DebateAnalysisResponse = {
    ...
    result?: {
        ...
        price?: number;
        /**
         * Investment recommendation from multi-agent debate
         */
        decision?: 'BUY' | 'SELL' | 'HOLD';
        /**
         * Detailed analysis from agents
         */
        analysis?: string;
        /**
        ...
        /**
         * Complete final decision with rationale
         */
    ...
    error?: string;
    /**
     * Raw output from analysis (only if quiet=false)
     */
    output?: string;
};
 ...
 */
export declare const getDebateAgents: <ThrowOnError extends boolean = false>(options: Options<GetDebateAgentsData, ThrowOnError>) => RequestResult<GetDebateAgentsResponses, GetDebateAgentsErrors, ThrowOnError, "fields">;

export declare type GetDebateAgentsData = {
    body?: never;
    path?: never;
    query: {
        /**
...
export declare type GetDebateAgentsErrors = {
    /**
...
export declare type GetDebateAgentsResponse = GetDebateAgentsResponses[keyof GetDebateAgentsResponses];

export declare type GetDebateAgentsResponses = {
    /**
     * Successful analysis
     */
 ...
 */
export declare const postDebateAgents: <ThrowOnError extends boolean = false>(options: Options<PostDebateAgentsData, ThrowOnError>) => RequestResult<PostDebateAgentsResponses, PostDebateAgentsErrors, ThrowOnError, "fields">;

export declare type PostDebateAgentsData = {
    body: {
        /**
         * Stock ticker symbol
         */
        ticker: string;
        /**
         * Use quick mode (Gemini Flash) for faster analysis
         */
        quickMode?: boolean;
        /**
         * Return only final results without verbose output
         */
        quiet?: boolean;
    };
    path?: never;
...
export declare type PostDebateAgentsErrors = {
    /**
     * Invalid request
     */
    400: unknown;
...
export declare type PostDebateAgentsResponse = PostDebateAgentsResponses[keyof PostDebateAgentsResponses];

export declare type PostDebateAgentsResponses = {
    /**
     * Successful analysis
     */
    200: DebateAnalysisResponse;
